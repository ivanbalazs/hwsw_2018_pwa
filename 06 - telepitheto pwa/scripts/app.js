...
(function () {
    ...
    document.getElementById('installBtnHolder').addEventListener('click', installBtnClickHandler);
})();
...
function beforeInstallPromptHandler(e) {
    ...
    document.getElementById('installBtnHolder').style.display = 'flex';
}

function installBtnClickHandler(e) {
    document.getElementById('installBtnHolder').style.display = 'none';
